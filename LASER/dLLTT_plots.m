...
plot(dist_axis(iplot_submeso),-dump(iplot_submeso),...
    'Color','[0.8500 0.3250 0.0980]','Linestyle','-','Linewidth',3.5)
hold on
plot(dist_axis(iplot_submeso),dlt_m2_mag(iplot_submeso),'Color','[0 0.4470 0.7410]')
hold on
...
plot(dist_axis(iplot_submeso),-dump(iplot_submeso),...
    'Color','[0.8500 0.3250 0.0980]','Linestyle','-','Linewidth',3.5)
hold on
plot(dist_axis(iplot_submeso),dll_m0_ensemble(iplot_submeso),'Color','[0.9290 0.6940 0.1250]')
hold on
plot(dist_axis(iplot_submeso),dll_m2_mag(iplot_submeso),'Color','[0 0.4470 0.7410]')
hold on
...
plot(dist_axis(iplot_submeso),-dump(iplot_submeso),...
    'Color','[0.8500 0.3250 0.0980]','Linestyle','-','Linewidth',3.5)
hold on
plot(dist_axis(iplot_submeso),dtt_m0_ensemble(iplot_submeso),'Color','[0.9290 0.6940 0.1250]')
hold on
plot(dist_axis(iplot_submeso),dtt_m2_mag(iplot_submeso),'Color','[0 0.4470 0.7410]')
hold on
...
figure(2);subplot(3,2,1) 
plot(dist_axis(iplot_submeso),dlt_2M_mag(iplot_submeso),'Color','[0.4660 0.6740 0.1880]')
hold on
...
figure(2);subplot(3,2,3) 
plot(dist_axis(iplot_submeso),dll_2M_mag(iplot_submeso),'Color','[0.4660 0.6740 0.1880]')
hold on
...
figure(2);subplot(3,2,5) 
plot(dist_axis(iplot_submeso),dtt_2M_mag(iplot_submeso),'Color','[0.4660 0.6740 0.1880]')
hold on
...
figure(3)
%subplot(1,2,2)
plot(dist_axis,alphafactor_var,'o')
hold on
